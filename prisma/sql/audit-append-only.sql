...
CREATE OR REPLACE FUNCTION ganji_audit_append_only() RETURNS trigger AS $$
BEGIN
...
CREATE TRIGGER audit_append_only
  ...
  FOR EACH ROW EXECUTE FUNCTION ganji_audit_append_only();
...
CREATE TRIGGER audit_no_truncate
  ...
  FOR EACH STATEMENT EXECUTE FUNCTION ganji_audit_append_only();
