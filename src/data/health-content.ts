 ...
 * nationales sont enregistrées ou synthétisées séparément. `langsAvailable`
 * indique les langues pour lesquelles un audio est livré dans la démo
 * (fon et bariba en priorité).
 *
...
export interface AudioMessageData {
  ...
  fr: string;
  en: string;
  langsAvailable: NationalLanguage[];
}
...
export const AUDIO_MESSAGES: AudioMessageData[] = [
  {
    ...
    langsAvailable: ['fon', 'bariba', 'yoruba', 'dendi'],
  },
  {
    key: 'consent.request',
  ...
  },
  {
    ...
    langsAvailable: ['fon', 'bariba', 'yoruba'],
  },
  {
